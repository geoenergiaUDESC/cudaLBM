...
Description
    Helper for printing each boundary fallback only once during execution 
...
Notes
    Intended to be called within a case block inside a boundary switch statement.

\*---------------------------------------------------------------------------*/

#ifndef __MLBM_PRINTONCE_CUH
#define __MLBM_PRINTONCE_CUH
