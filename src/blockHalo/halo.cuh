    ...
    namespace device
    {
        ...
        public:
                ...
                const scalar_t *const ptrRestrict fz1) noexcept
            {
                ...
                if (tx == 0)
                { // w
                    pop(label_constant<1>()) = __ldg(&fx1[idxPopX<0, VSet::QF()>(ty, tz, bxm1, by, bz)]);
                    pop(label_constant<7>()) = __ldg(&fx1[idxPopX<1, VSet::QF()>(tym1, tz, bxm1, ((ty == 0) ? bym1 : by), bz)]);
                    pop(label_constant<9>()) = __ldg(&fx1[idxPopX<2, VSet::QF()>(ty, tzm1, bxm1, by, ((tz == 0) ? bzm1 : bz))]);
                    pop(label_constant<13>()) = __ldg(&fx1[idxPopX<3, VSet::QF()>(typ1, tz, bxm1, ((ty == (block::ny() - 1)) ? byp1 : by), bz)]);
                    pop(label_constant<15>()) = __ldg(&fx1[idxPopX<4, VSet::QF()>(ty, tzp1, bxm1, by, ((tz == (block::nz() - 1)) ? bzp1 : bz))]);
                }
                else if (tx == (block::nx() - 1))
                { // e
                    pop(label_constant<2>()) = __ldg(&fx0[idxPopX<0, VSet::QF()>(ty, tz, bxp1, by, bz)]);
                    pop(label_constant<8>()) = __ldg(&fx0[idxPopX<1, VSet::QF()>(typ1, tz, bxp1, ((ty == (block::ny() - 1)) ? byp1 : by), bz)]);
                    pop(label_constant<10>()) = __ldg(&fx0[idxPopX<2, VSet::QF()>(ty, tzp1, bxp1, by, ((tz == (block::nz() - 1)) ? bzp1 : bz))]);
                    pop(label_constant<14>()) = __ldg(&fx0[idxPopX<3, VSet::QF()>(tym1, tz, bxp1, ((ty == 0) ? bym1 : by), bz)]);
                    pop(label_constant<16>()) = __ldg(&fx0[idxPopX<4, VSet::QF()>(ty, tzm1, bxp1, by, ((tz == 0) ? bzm1 : bz))]);
                }

                if (ty == 0)
                { // s
                    pop(label_constant<3>()) = __ldg(&fy1[idxPopY<0, VSet::QF()>(tx, tz, bx, bym1, bz)]);
                    pop(label_constant<7>()) = __ldg(&fy1[idxPopY<1, VSet::QF()>(txm1, tz, ((tx == 0) ? bxm1 : bx), bym1, bz)]);
                    pop(label_constant<11>()) = __ldg(&fy1[idxPopY<2, VSet::QF()>(tx, tzm1, bx, bym1, ((tz == 0) ? bzm1 : bz))]);
                    pop(label_constant<14>()) = __ldg(&fy1[idxPopY<3, VSet::QF()>(txp1, tz, ((tx == (block::nx() - 1)) ? bxp1 : bx), bym1, bz)]);
                    pop(label_constant<17>()) = __ldg(&fy1[idxPopY<4, VSet::QF()>(tx, tzp1, bx, bym1, ((tz == (block::nz() - 1)) ? bzp1 : bz))]);
                }
                else if (ty == (block::ny() - 1))
                { // n
                    pop(label_constant<4>()) = __ldg(&fy0[idxPopY<0, VSet::QF()>(tx, tz, bx, byp1, bz)]);
                    pop(label_constant<8>()) = __ldg(&fy0[idxPopY<1, VSet::QF()>(txp1, tz, ((tx == (block::nx() - 1)) ? bxp1 : bx), byp1, bz)]);
                    pop(label_constant<12>()) = __ldg(&fy0[idxPopY<2, VSet::QF()>(tx, tzp1, bx, byp1, ((tz == (block::nz() - 1)) ? bzp1 : bz))]);
                    pop(label_constant<13>()) = __ldg(&fy0[idxPopY<3, VSet::QF()>(txm1, tz, ((tx == 0) ? bxm1 : bx), byp1, bz)]);
                    pop(label_constant<18>()) = __ldg(&fy0[idxPopY<4, VSet::QF()>(tx, tzm1, bx, byp1, ((tz == 0) ? bzm1 : bz))]);
                }

                if (tz == 0)
                { // b
                    pop(label_constant<5>()) = __ldg(&fz1[idxPopZ<0, VSet::QF()>(tx, ty, bx, by, bzm1)]);
                    pop(label_constant<9>()) = __ldg(&fz1[idxPopZ<1, VSet::QF()>(txm1, ty, ((tx == 0) ? bxm1 : bx), by, bzm1)]);
                    pop(label_constant<11>()) = __ldg(&fz1[idxPopZ<2, VSet::QF()>(tx, tym1, bx, ((ty == 0) ? bym1 : by), bzm1)]);
                    pop(label_constant<16>()) = __ldg(&fz1[idxPopZ<3, VSet::QF()>(txp1, ty, ((tx == (block::nx() - 1)) ? bxp1 : bx), by, bzm1)]);
                    pop(label_constant<18>()) = __ldg(&fz1[idxPopZ<4, VSet::QF()>(tx, typ1, bx, ((ty == (block::ny() - 1)) ? byp1 : by), bzm1)]);
                }
                else if (tz == (block::nz() - 1))
                { // f
                    pop(label_constant<6>()) = __ldg(&fz0[idxPopZ<0, VSet::QF()>(tx, ty, bx, by, bzp1)]);
                    pop(label_constant<10>()) = __ldg(&fz0[idxPopZ<1, VSet::QF()>(txp1, ty, ((tx == (block::nx() - 1)) ? bxp1 : bx), by, bzp1)]);
                    pop(label_constant<12>()) = __ldg(&fz0[idxPopZ<2, VSet::QF()>(tx, typ1, bx, ((ty == (block::ny() - 1)) ? byp1 : by), bzp1)]);
                    pop(label_constant<15>()) = __ldg(&fz0[idxPopZ<3, VSet::QF()>(txm1, ty, ((tx == 0) ? bxm1 : bx), by, bzp1)]);
                    pop(label_constant<17>()) = __ldg(&fz0[idxPopZ<4, VSet::QF()>(tx, tym1, bx, ((ty == 0) ? bym1 : by), bzp1)]);
                }
            }
                ...
                scalar_t *const ptrRestrict gz1) noexcept
            {
                ...
                if (West(x))
                { // w
                    gx0[idxPopX<0, VSet::QF()>(ty, tz, blockIdx)] = pop(label_constant<2>());
                    gx0[idxPopX<1, VSet::QF()>(ty, tz, blockIdx)] = pop(label_constant<8>());
                    gx0[idxPopX<2, VSet::QF()>(ty, tz, blockIdx)] = pop(label_constant<10>());
                    gx0[idxPopX<3, VSet::QF()>(ty, tz, blockIdx)] = pop(label_constant<14>());
                    gx0[idxPopX<4, VSet::QF()>(ty, tz, blockIdx)] = pop(label_constant<16>());
                }
                if (East(x))
                { // e
                    gx1[idxPopX<0, VSet::QF()>(ty, tz, blockIdx)] = pop(label_constant<1>());
                    gx1[idxPopX<1, VSet::QF()>(ty, tz, blockIdx)] = pop(label_constant<7>());
                    gx1[idxPopX<2, VSet::QF()>(ty, tz, blockIdx)] = pop(label_constant<9>());
                    gx1[idxPopX<3, VSet::QF()>(ty, tz, blockIdx)] = pop(label_constant<13>());
                    gx1[idxPopX<4, VSet::QF()>(ty, tz, blockIdx)] = pop(label_constant<15>());
                }

                if (South(y))
                { // s
                    gy0[idxPopY<0, VSet::QF()>(tx, tz, blockIdx)] = pop(label_constant<4>());
                    gy0[idxPopY<1, VSet::QF()>(tx, tz, blockIdx)] = pop(label_constant<8>());
                    gy0[idxPopY<2, VSet::QF()>(tx, tz, blockIdx)] = pop(label_constant<12>());
                    gy0[idxPopY<3, VSet::QF()>(tx, tz, blockIdx)] = pop(label_constant<13>());
                    gy0[idxPopY<4, VSet::QF()>(tx, tz, blockIdx)] = pop(label_constant<18>());
                }
                if (North(y))
                { // n
                    gy1[idxPopY<0, VSet::QF()>(tx, tz, blockIdx)] = pop(label_constant<3>());
                    gy1[idxPopY<1, VSet::QF()>(tx, tz, blockIdx)] = pop(label_constant<7>());
                    gy1[idxPopY<2, VSet::QF()>(tx, tz, blockIdx)] = pop(label_constant<11>());
                    gy1[idxPopY<3, VSet::QF()>(tx, tz, blockIdx)] = pop(label_constant<14>());
                    gy1[idxPopY<4, VSet::QF()>(tx, tz, blockIdx)] = pop(label_constant<17>());
                }

                if (Back(z))
                { // b
                    gz0[idxPopZ<0, VSet::QF()>(tx, ty, blockIdx)] = pop(label_constant<6>());
                    gz0[idxPopZ<1, VSet::QF()>(tx, ty, blockIdx)] = pop(label_constant<10>());
                    gz0[idxPopZ<2, VSet::QF()>(tx, ty, blockIdx)] = pop(label_constant<12>());
                    gz0[idxPopZ<3, VSet::QF()>(tx, ty, blockIdx)] = pop(label_constant<15>());
                    gz0[idxPopZ<4, VSet::QF()>(tx, ty, blockIdx)] = pop(label_constant<17>());
                }
                if (Front(z))
                {
                    gz1[idxPopZ<0, VSet::QF()>(tx, ty, blockIdx)] = pop(label_constant<5>());
                    gz1[idxPopZ<1, VSet::QF()>(tx, ty, blockIdx)] = pop(label_constant<9>());
                    gz1[idxPopZ<2, VSet::QF()>(tx, ty, blockIdx)] = pop(label_constant<11>());
                    gz1[idxPopZ<3, VSet::QF()>(tx, ty, blockIdx)] = pop(label_constant<16>());
                    gz1[idxPopZ<4, VSet::QF()>(tx, ty, blockIdx)] = pop(label_constant<18>());
                }
            }
