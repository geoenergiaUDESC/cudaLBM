...
namespace LBM
{
    ...
    public:
         ...
         **/
        __device__ static inline thread::array<scalar_t, 27> reconstruct(const thread::array<scalar_t, 10> &moments) noexcept
        {
            const scalar_t pics2 = static_cast<scalar_t>(1.0) - cs2<scalar_t>() * (moments[m_i<4>()] + moments[m_i<7>()] + moments[m_i<9>()]);
        ...
        /**
         * @brief Calculate specific moment from population distribution (host)
         ...
         **/
        __device__ inline static void calculateMoments(const thread::array<scalar_t, 27> &pop, thread::array<scalar_t, 10> &moments) noexcept
        {
            // Density
