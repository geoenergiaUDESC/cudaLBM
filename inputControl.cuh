...
namespace mbLBM
{
    ...
    public:
         ...
         */
        [[nodiscard]] inputControl(const int argc, const char *argv[])
    ...
    private:
         ...
         */
        [[nodiscard]] std::size_t nArgsCheck(const int argc, const char *argv[]) const noexcept
        {
         ...
         * @param argv Second argument passed to main
         */
        [[nodiscard]] std::vector<std::string> parseCommandLine(const int argc, const char *argv[]) const noexcept
        {
            if (argc > 0)
            {
